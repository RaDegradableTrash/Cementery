...
- `Cementery > Performance > Start Visual Evidence Route` can be launched from Edit Mode; it queues the route, enters Play Mode, starts sampling after Play Mode is active, and requests report generation when the route finishes.
